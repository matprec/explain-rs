...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_b577265cd3151f100e291364d55aca4df6b11a93": function($0, $1) {
                Module.STDWEB.from_js($0, (function(){$.ajax ({type : "GET" , url : Module.STDWEB.to_js($1), success : function (data){console.log (data); load_src (data);}});})());
            },
            "__extjs_deb5ccee02a2751a1440449307b4bf0578fe5125": function($0, $1, $2, $3, $4) {
                Module.STDWEB.from_js($0, (function(){Module.exports.explain = Module.STDWEB.to_js($1); Module.exports.fetch_src = Module.STDWEB.to_js($2); Module.exports.list_examples = Module.STDWEB.to_js($3); Module.exports.load_example = Module.STDWEB.to_js($4);})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.explain_rs.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "explain-rs.wasm" );
        ...
        const __promise = fetch( "explain-rs.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'explain_rs'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'explain_rs':", error );
                throw error;
            });

        Rust.explain_rs = __promise;
        return __promise;
    }
}));
